...
/* scaling */
ImVec2 UISettings::m_baseSize = ImVec2(1280.0f, 790.0f);
ImVec2 UISettings::m_scaleFactor = ImVec2(1.0f, 1.0f);

/* font */
float UISettings::m_fontSize = 40.0f;//26.0f;//24.0f;
float UISettings::m_outlineSize = 2.0f;

/* ////////////////// pos & size ////////////////// */

/* widgets */
float UISettings::m_padding = 25.0f;
...
ImVec2 UISettings::m_buttonPanelSize = ImVec2(380.0f/*250.0f*//*180.0f*//*250.0f*/, 100.0f); //ImVec2(120.0f, 45.0f);
