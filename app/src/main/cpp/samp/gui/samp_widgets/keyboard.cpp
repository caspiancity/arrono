...
void Keyboard::performLayout()
{
    ...
    /* O correto é subtrair a altura do input do total, sem somar valores fixos */
    float layoutHeight = height() - m_input->height();

    /* ENG */
    m_layoutLowerENG->setFixedSize(ImVec2(width(), layoutHeight));
    m_layoutLowerENG->setPosition(ImVec2(0.0f, UISettings::keyboardRowHeight()));
    m_layoutUpperENG->setFixedSize(ImVec2(width(), layoutHeight));
    m_layoutUpperENG->setPosition(ImVec2(0.0f, UISettings::keyboardRowHeight()));

    /* RU */
    m_layoutLowerRU->setFixedSize(ImVec2(width(), layoutHeight));
    m_layoutLowerRU->setPosition(ImVec2(0.0f, UISettings::keyboardRowHeight()));
    m_layoutUpperRU->setFixedSize(ImVec2(width(), layoutHeight));
    m_layoutUpperRU->setPosition(ImVec2(0.0f, UISettings::keyboardRowHeight()));

    /* NUM */
    m_layoutNUM->setFixedSize(ImVec2(width(), layoutHeight));
...
void KeyboardLayoutUpperRU::performLayout()
{
    m_rows[0]->setPadding(0.0f);
    m_rows[0]->setSpacing(0.0f);
    // Versões em Maiúsculo (HEX)
    m_rows[0]->addKey(Encoding::cp2utf("É"), 0xC9);
    m_rows[0]->addKey(Encoding::cp2utf("Ö"), 0xD6);
    m_rows[0]->addKey(Encoding::cp2utf("Ó"), 0xD3);
    m_rows[0]->addKey(Encoding::cp2utf("Ê"), 0xCA);
    m_rows[0]->addKey(Encoding::cp2utf("Å"), 0xC5);
    m_rows[0]->addKey(Encoding::cp2utf("Í"), 0xCD);
    m_rows[0]->addKey(Encoding::cp2utf("Ã"), 0xC3);
    m_rows[0]->addKey(Encoding::cp2utf("Ø"), 0xD8);
    m_rows[0]->addKey(Encoding::cp2utf("Ù"), 0xD9);
    m_rows[0]->addKey(Encoding::cp2utf("Ç"), 0xC7);
    m_rows[0]->addKey(Encoding::cp2utf("Õ"), 0xD5);

    m_rows[1]->setPadding(0.0f);
    m_rows[1]->setSpacing(0.0f);
    m_rows[1]->addKey(Encoding::cp2utf("Ô"), 0xD4);
    m_rows[1]->addKey(Encoding::cp2utf("Û"), 0xDB);
    m_rows[1]->addKey(Encoding::cp2utf("Â"), 0xC2);
    m_rows[1]->addKey(Encoding::cp2utf("À"), 0xC0);
    m_rows[1]->addKey(Encoding::cp2utf("Ï"), 0xCF);
    m_rows[1]->addKey(Encoding::cp2utf("Ð"), 0xD0);
    m_rows[1]->addKey(Encoding::cp2utf("Î"), 0xCE);
    m_rows[1]->addKey(Encoding::cp2utf("Ë"), 0xCB);
    m_rows[1]->addKey(Encoding::cp2utf("Ä"), 0xC4);
    m_rows[1]->addKey(Encoding::cp2utf("Æ"), 0xC6);
    m_rows[1]->addKey(Encoding::cp2utf("Ý"), 0xDD);

    ImVec2 keySize = ImVec2(width() / 11, UISettings::keyboardRowHeight());
    m_rows[2]->setPadding(0.0f);
    m_rows[2]->setSpacing(0.0f);
    m_rows[2]->addKey(ExtendedKey::SHIFT_ON)->setFixedSize(ImVec2(keySize.x * 1.5f, 0.0f));
    m_rows[2]->addKey(Encoding::cp2utf("ß"), 0xDF);
    m_rows[2]->addKey(Encoding::cp2utf("×"), 0xD7);
    m_rows[2]->addKey(Encoding::cp2utf("Ñ"), 0xD1);
    m_rows[2]->addKey(Encoding::cp2utf("Ì"), 0xCC);
    m_rows[2]->addKey(Encoding::cp2utf("È"), 0xC8);
    m_rows[2]->addKey(Encoding::cp2utf("Ò"), 0xD2);
    m_rows[2]->addKey(Encoding::cp2utf("Ü"), 0xDC);
    m_rows[2]->addKey(Encoding::cp2utf("Á"), 0xC1);
    m_rows[2]->addKey(Encoding::cp2utf("Þ"), 0xDE);
    m_rows[2]->addKey(ExtendedKey::BACKSPACE)->setFixedSize(ImVec2(keySize.x * 1.5f, 0.0f));
	m_rows[3]->setPadding(0.0f);
	m_rows[3]->setSpacing(0.0f);
	//m_rows[4]->addKey(std::string ("/", '/')->setFixedSize(ImVec2(keySize.x * 1.5f, 0.0f));
