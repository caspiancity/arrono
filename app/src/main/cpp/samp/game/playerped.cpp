...
CPlayerPed::CPlayerPed(int iNum, int iSkin, float fX, float fY, float fZ, float fRotation)
{
    ...
    ((void (*)(int))(g_libGTASA + 0x5C0FD4))(iPlayerNum); // CPlayerPed::SetupPlayerPed
    //4543D4 ; CPlayerPed::DeactivatePlayerPed
    ((void (*)(int))(g_libGTASA + 0x5C1140))(iPlayerNum); // CPlayerPed::DeactivatePlayerPed
    //3AC5DC ; FindPlayerPed(int)
    m_pPed = FindPlayerPed(iNum); // CPlayerPed::FindPlayerPed

    CVector posn = {fX, fY, fZ};
    ((void (*)(const CVector&, CEntityGTA*))(g_libGTASA + 0x419BE0))(posn, m_pPed); // CTheScripts::ClearSpaceForMissionEntity
    //4543F8 ; CPlayerPed::ReactivatePlayerPed
    ((void (*)(int))(g_libGTASA+0x5C1158))(iPlayerNum); // CPlayerPed::ReactivatePlayerPed
...
CPlayerPed::~CPlayerPed()
{
	...
	if (m_pPed && (GamePool_Ped_GetAt(m_dwGTAId) != 0) && IsValidGamePed(m_pPed) /* CPlaceable */)
	{
        ...
        ((void (*)(uintptr_t))(g_libGTASA + 0x5CDC64))((uintptr_t)m_pPed);
...
bool CPlayerPed::IsPlayingAnimation(int iIndex)
{
	...
	uintptr_t blendAssoc = ((uintptr_t(*)(RpClump* clump, const char* szName))(g_libGTASA + 0x46AAF4))
...
{
	uintptr_t* pBlendAssocGroup = *(uintptr_t * *)(g_libGTASA + 0xBA88A8); // CAnimManager::ms_aAnimAssocGroups
...
void CPlayerPed::SetInitialState()
{
    ...
    CHook::CallFunction<void>(g_libGTASA + 0x5C0D50, m_pPed);
}
// 0.3.7
...
bool IsPedModel(unsigned int iModelID)
{
    ...
    if(ModelInfo && *(uintptr_t*)ModelInfo == (uintptr_t)g_libGTASA + 0x82F310)
        return true;
...
void CPlayerPed::ClearWeapons()
{
	...
	((void (*)(CPedGTA*))(g_libGTASA + 0x595604))(m_pPed); // CPed::ClearWeapons
    CWorld::PlayerInFocus = 0;
}
...
void CPlayerPed::GetTransformedBonePosition(int iBoneID, CVector* vecOut)
{
	...
	((void (*)(CPedGTA*, CVector*, int, int))(g_libGTASA + 0x598670))(m_pPed, vecOut, iBoneID, 0);
}
...
void CPlayerPed::GetWeaponInfoForFire(bool bLeftWrist, CVector* vecBonePos, CVector* vecOut)
{
    ...
    if (pFireOffset && vecBonePos && vecOut) {
        ...
        // CPed::GetTransformedBonePosition
        ((void (*)(CPedGTA*, CVector*, int, bool))(g_libGTASA + 0x598670))(m_pPed, vecOut, bone_id, false);
    }
}
...
uintptr_t GetWeaponInfo(int iWeapon, int iSkill)
{
    ...
    return ((uintptr_t(*)(int, int))(g_libGTASA + 0x709BA8))(iWeapon, iSkill);
}
// 0.3.7
...
void CPlayerPed::ApplyCrouch()
{
    ...
    if (!(m_pPed->bIsDucking))
    {
        if (!IsCrouching())
        {
            ...
            {
                ((int (*)(CPedIntelligence*, uint16_t))(g_libGTASA + 0x5BCE70))(m_pPed->m_pIntelligence, 0);
            }
        }
    }
}
...
void CPlayerPed::ResetCrouch()
{
    ...
    if (m_pPed->m_pIntelligence)
    {
        ((int (*)(CPedIntelligence*))(g_libGTASA + 0x5BCFF8))(m_pPed->m_pIntelligence);
    }
}
