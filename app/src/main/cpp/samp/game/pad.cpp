...
uint32_t CCamera_IsTargetingActive_hook(uintptr_t thiz, CPedGTA* pPed)
{
    ...
    else
    {
        ...
        static CCamera& TheCamera = *reinterpret_cast<CCamera*>(g_libGTASA + 0xBBA8D0);
        uint32_t bIsTargeting = CHook::CallFunction<bool>(g_libGTASA + 0x4B8154, &TheCamera);
...
void AllVehicles__ProcessControl_hook(uintptr_t thiz)
{
            ...
            CWorld::PlayerInFocus  == 0) // CWorld::PlayerInFocus
    {
        ...
        (( void (*)(uintptr_t))(g_libGTASA + 0x489B78))(reinterpret_cast<uintptr_t>(&pVehicle->m_VehicleAudioEntity));
    ...
    (( void (*)(CVehicleGTA*))(g_libGTASA + call_addr + 0))(pVehicle);
}
...
void CPed__ProcessControl_hook(uintptr_t thiz)
{
    ...
    if (dwCurPlayerActor && (byteCurPlayer != 0))
    {
        ...
        *wCameraMode2 = GameGetPlayerCameraMode(byteCurPlayer);
        ...
        CHook::NOP(g_libGTASA + 0x598D1C, 2);
...
uint32_t TaskUseGun(uintptr_t thiz, uintptr_t ped)
{
        ...
        (byteCurPlayer != 0)) // not local player and local player's keys set.
    {
        ...
        *wCameraMode2 = GameGetPlayerCameraMode(byteCurPlayer);
        ...
        result = ((uint32_t(*)(uintptr_t, uintptr_t))(g_libGTASA + 0x5DFCC4))(thiz, ped);
...
uint32_t CPad__TaskProcess(uintptr_t thiz, uintptr_t ped, int unk, int unk1)
{
    ...
    uint32_t result =  ((uint32_t(*)(uintptr_t, uintptr_t, int, int))(g_libGTASA + 0x655E28))(thiz, ped, unk, unk1);
    CWorld::PlayerInFocus = old;
    return result;
}
...
void HookCPad()
{
    ...
    CHook::InstallPLT(g_libGTASA + 0x833150, &CPed__ProcessControl_hook, &CPed__ProcessControl);

    // all vehicles ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83BBA8, &AllVehicles__ProcessControl_hook); // CAutomobile::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83C2F8, &AllVehicles__ProcessControl_hook); // CBoat::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83BE98, &AllVehicles__ProcessControl_hook); // CBike::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83C9C0, &AllVehicles__ProcessControl_hook); // CPlane::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83C520, &AllVehicles__ProcessControl_hook); // CHeli::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83C0C8, &AllVehicles__ProcessControl_hook); // CBmx::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83C770, &AllVehicles__ProcessControl_hook); // CMonsterTruck::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83CC10, &AllVehicles__ProcessControl_hook); // CQuadBike::ProcessControl
    CHook::InstallPLT(g_libGTASA + 0x83D0B0, &AllVehicles__ProcessControl_hook); // CTrain::ProcessControl

    CHook::InstallPLT(g_libGTASA + 0x833928, &TaskUseGun);
    CHook::InstallPLT(g_libGTASA + 0x83ACF8, &CPad__TaskProcess);
